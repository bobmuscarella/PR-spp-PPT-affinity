...
I put a zip file on Github with some data used:
...
The following data is downloaded separately by the script:
...
## Get global climate data from the Chelsa dataset
...
## Acquire and process BIEN occurrences
